...
use common::{AppConfig, Employee, EmployeeId, Role, Schedule, Sex, Weekday};
use rand::rng;
...
impl ScheduleGenerator {
    ...
    fn apply_mentee_constraints(
        ...
        use common::config::MenteeOverlapMode;
...
mod tests {
    ...
    fn test_mentee_constraint() {
        ...
        config.schedule.mentee_mentor_overlap = common::config::MenteeOverlapMode::AtLeastOne;
